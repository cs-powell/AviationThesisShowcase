    ...
    def __init__(self):
        self.globalParameters = {
            parameterType.AIRCRAFT_STATE : {
                ...
                "latitude"          : ["sim/flightmodel/position/latitude",39.896,0,0,0,0],
                "longitude"         : ["sim/flightmodel/position/longitude",-104.692,0,0,0,0],
                ...
                "flaps"             : ["sim/flightmodel2/controls/flap1_deploy_ratio",0,0,0,0,0],
